...
<img src="lastname_project_01_files/figure-html/visualization-1-1.png" alt="Bar chart showing Tuesday has the highest average births and Sunday has the lowest, with weekends colored differently than weekdays using a viridis palette."  />
...
<img src="lastname_project_01_files/figure-html/season-births-1-1.png" alt="Original box plot of births by season, using non-accessible colors and missing labels."  />
...
<img src="lastname_project_01_files/figure-html/vis-3-after-1.png" alt="A redesigned violin and box plot showing summer has the highest density of high-birth days, using a colorblind safe viridis palette."  />

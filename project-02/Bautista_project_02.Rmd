...
ggplot(houseresultsnoint, aes(x = estimate, y = term, color = term)) + # Map color to the variable
...
ggsave(here("figures", "housing_coefficient_plot.png"), width = 8, height = 6, dpi = 300)
```
### Redesign (Bad)
